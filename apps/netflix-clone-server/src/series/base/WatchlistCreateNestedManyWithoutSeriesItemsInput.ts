...
@InputType()
class WatchlistCreateNestedManyWithoutSeriesItemsInput {
...
export { WatchlistCreateNestedManyWithoutSeriesItemsInput as WatchlistCreateNestedManyWithoutSeriesItemsInput };
